...
<?php if ($like_result->num_rows > 0): ?>
    ...
    <form id="like-form-<?php echo $tweet['id']; ?>" style="display:inline;">
        ...
        <button type="button" onclick="likeTweet(<?php echo $tweet['id']; ?>)"
            ...
            <span style="font-size: 16px;">❤️</span> <span id="like-count-<?php echo $tweet['id']; ?>"><?php echo $like_count; ?></span>
        </button>
    </form>
<?php else: ?>
    <!-- Unliked Tweet -->
    <form id="like-form-<?php echo $tweet['id']; ?>" style="display:inline;">
        ...
        <button type="button" onclick="likeTweet(<?php echo $tweet['id']; ?>)"
            ...
            <span style="font-size: 16px;">🤍</span> <span id="like-count-<?php echo $tweet['id']; ?>"><?php echo $like_count; ?></span>
        </button>
    </form>
<?php endif; ?>
